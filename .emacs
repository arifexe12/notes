...
(custom-set-variables
 ...
 '(package-selected-packages '(auto-complete spacemacs-theme dracula-theme zenburn-theme
					     afternoon-theme)))
(custom-set-faces
...
(add-hook 'after-find-file (lambda() 
...
(defun convert-to-paragraph() (interactive) (fill-paragraph))
